...
<template>
  <div class="flex flex-col w-full relative" :class="[disabled ? 'opacity-60' : '']">
    ...
    <div class="flex w-full items-center">
      <div
        v-if="preIcon"
        class="p-2 border border-slate-400 border-r-0 rounded rounded-r-none bg-white dark:bg-slate-800 z-0"
        :class="{
      ...
      <div
        v-if="suffIcon"
        class="p-2 border border-slate-400 border-l-0 rounded rounded-l-none bg-white dark:bg-slate-800 z-0;"
        :class="{
          'important:border-red-500 important:ring-red-500 mb-1': errorMessage,
        }"
...
.text-field-input {
  @apply w-full border border-slate-400 rounded px-3 py-2 z-0;
